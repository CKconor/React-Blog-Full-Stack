        ...
        {data.projectsCollection.items.slice(0, 3).map((project) => {
          return (
            <Link
              ...
              className="cursor-pointer project-card sm:mb-0 w-full md:w-auto mb-4  hover:scale-105 transition-all min-h-[210px] mr-8 flex flex-col basis-1/3 border-4 dark:border-lightmode border-darkmode rounded-lg px-8 py-6"
            >
              <div>
