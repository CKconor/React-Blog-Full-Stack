  ...
  return (
    <div className="flex flex-row">
      <div className="flex flex-col mt-10 basis-1/2">
        ...
        <h2 className="font-bold text-4xl mb-3">Job Title</h2>
        <p>Software Engineer & Frontend Developer</p>
        <h2 className="font-bold text-4xl mb-3 mt-6">Experience</h2>
        <p className="mb-4">
        ...
        <h2 className="font-bold text-4xl mb-3 mt-6">Work History</h2>
        <span className="text-xs text-lightsubtext dark:text-darksubtext mt-0">Jan 2022 - Present</span>
        <h3 className="font-bold text-2xl mb-1 mt-0">Raytheon UK</h3>
        <p className="mb-4">
        ...
        <h3 className="font-bold text-2xl mb-1 mt-0">Gtech Creative Frontend Developer</h3>
        <p className="mb-4">
        ...
        <h3 className="font-bold text-2xl mb-1 mt-0">This is Union - Junior Developer</h3>
        <p className="mb-4">
